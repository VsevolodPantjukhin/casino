...
import "./WithdrawMethodBlock.css";
...
const WithdrawMethodBlock = () => {
  return (
    <div className="withdraw-method-block">
      <div className="withdraw-method-card">
        <div>
          <img src={qiwiLogo} />
          <p>QIWI</p>
        </div>
...
export default WithdrawMethodBlock;
